...
if (WINDOWS OR DARWIN )
  ...
  elseif(LL_GENERATOR_IS_MULTI_CONFIG)
    ...
    set(SHARED_LIB_STAGING_DIR ${CMAKE_BINARY_DIR}/sharedlibs/${CMAKE_BUILD_TYPE})
  ...
  if(LL_GENERATOR_IS_MULTI_CONFIG)
    set(EXE_STAGING_DIR ${CMAKE_BINARY_DIR}/sharedlibs/$<CONFIG>)
  else()
