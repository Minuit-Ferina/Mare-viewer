...
{
    mEnableWhiteList = get_owner_child< LLCheckBoxCtrl >(this,  LLMediaEntry::WHITELIST_ENABLE_KEY );
    mWhiteListList = get_owner_child< LLScrollListCtrl >(this,  LLMediaEntry::WHITELIST_KEY );
    mHomeUrlFailsWhiteListText = get_owner_child<LLTextBox>(this,  "home_url_fails_whitelist" );
