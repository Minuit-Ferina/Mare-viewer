...
bool LLSetKeyBindDialog::postBuild()
{
    ...
    get_owner_child<LLUICtrl>(this, "Cancel")->setFocus(true);

    pCheckBox = get_owner_child<LLCheckBoxCtrl>(this, "apply_all");
    pDescription = get_owner_child<LLTextBase>(this, "description");
