...
public:
    ...
    virtual U32 emitTransparentWorldCommands(LLWorldRenderCommandBuffer& commands, F32 pixelArea, bool first_pass = true, bool is_dummy = false);

    // Draws the shape attached to a joint.
    // Called by render().
    virtual U32 drawShape( F32 pixelArea, bool first_pass = true, bool is_dummy = false );
    virtual U32 appendWorldCommand(
