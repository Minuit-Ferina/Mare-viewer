...
vec3 legacy_material_lighting(vec3 base_color, vec2 texcoord)
{
    ...
    vec3 specular_color = pc.material_legacy.rgb;
        ...
        !has_material_flag(MATERIAL_HAS_ORM_MAP))
    {
        ...
        specular_color *= legacy_spec.rgb;
...
void main()
{
    ...
    frag_color = vec4(legacy_material_lighting(color.rgb, vary_material_texcoord0.xy) + emissive, color.a);
}
