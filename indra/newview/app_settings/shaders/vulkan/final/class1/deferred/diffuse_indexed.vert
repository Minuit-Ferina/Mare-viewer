...
// Final Vulkan deferred diffuse indexed vertex path.
// Source OpenGL role: class1/deferred/diffuseV.glsl.
// This keeps the current Vulkan world push-constant/skinning contract so the
