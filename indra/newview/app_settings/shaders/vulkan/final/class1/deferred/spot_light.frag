...
// Faithful source-level Vulkan port of class1/deferred/spotLightF.glsl.
// Class 1 spotlights preserve the no-shadow legacy projected-light path.
...
layout(set = 1, binding = 0) uniform MareSpotLightClass1Uniforms
{
...
void main()
{
    ...
    float fa = u.color_falloff.a + 1.0;
        ...
        proj_tc.y > 0.0)
    {
        ...
        if (da > 0.0)
        {
            ...
            dlit = u.color_falloff.rgb * plcol.rgb * plcol.a;
        ...
        col += amb_da * u.color_falloff.rgb * diff_tex.rgb * amb_plcol.rgb * amb_plcol.a * diff_tex.rgb;
    }
